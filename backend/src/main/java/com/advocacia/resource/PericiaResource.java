...
public class PericiaResource {
    ...
    public Response criar(PericiaRequest request) {
        ...
        logService.registrar(getUserId(), "CREATE", "Perícia", entity.id, "Criou perícia para processo: " + entity.processoNumero, getClientIp(), getUserAgent());
    ...
    public Response atualizar(@PathParam("id") Long id, PericiaRequest request) {
        ...
        logService.registrar(getUserId(), "UPDATE", "Perícia", entity.id, "Atualizou perícia: " + processoNumeroAntigo + " -> " + entity.processoNumero, getClientIp(), getUserAgent());
        return Response.ok(toResponse(entity)).build();
    ...
    public Response deletar(@PathParam("id") Long id) {
        ...
        logService.registrar(getUserId(), "DELETE", "Perícia", id, "Excluiu perícia do processo: " + processoNumero, getClientIp(), getUserAgent());
